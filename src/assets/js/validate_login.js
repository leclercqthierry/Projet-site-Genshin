...
const errorN =
    "Votre pseudo doit contenir au moins 4 caractères alphanumériques sans espaces ni caractères spéciaux!";
const errorP =
...
form.addEventListener("submit", (e) => {
    if (
        !regexNickname.test(nickname.value) ||
        ...
        errorNickname.style.display = !regexNickname.test(nickname.value)
            ? "block"
            : "none";
