// The purpose of this script is to validate the edit team form on the front side

const form1 = document.querySelector('form[name="edit-team-name-form"]');
const form2 = document.querySelector('form[name="edit-characters-form"]');
...
if (form1 !== null) {
    ...
    form1.addEventListener("submit", (e) => {
        ...
        if (!regexName.test(teamName.value) || teamName.value === "") {
            showError(
                "Veuillez entrer un nom valide pour votre équipe.",
                errorForm,
            );
        }
...
if (form2 !== null) {
    ...
    form2.addEventListener("submit", (e) => {
        ...
        if (!checkAllDifferent(teamChars)) {
            showError(
                "Tous les personnages doivent être différents.",
                errorForm,
            );
        } else {
            form2.submit();
