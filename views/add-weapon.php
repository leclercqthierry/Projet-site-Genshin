...
<body>
    ...
    <main>
        ...
        <div class="container">
            <form action="#" method="post" name="add-weapon-form">
                <div id="group1">
                ...
                <div class="form-label-groups">
                    <div class="form-label">
                        <fieldset>
                            ...
                            <input type="file" name="mob-mat1-r1" id="mob-mat1-r1" accept="image/*" required>
                        </fieldset>
                    </div>
                    <div class="form-label">
                        <fieldset>
                            <legend>Mob matériel 1 rareté 2</legend>
                            <input type="file" name="mob-mat1-r2" id="mob-mat1-r2" accept="image/*" required>
                        </fieldset>
                    ...
                    <div class="form-label">
                        <fieldset>
                            ...
                            <input type="file" name="mob-mat1-r3" id="mob-mat1-r3" accept="image/*" required>
                        </fieldset>   
                    </div>
                </div>
                <div class="form-label-groups">
                    <div class="form-label">
                        <fieldset>
                            ...
                            <input type="file" name="mob-mat2-r2" id="mob-mat2-r2" accept="image/*" required>
                        </fieldset>
                    </div>
                    <div class="form-label">
                        <fieldset>
                            <legend>Mob matériel 2 rareté 3</legend>
                            <input type="file" name="mob-mat2-r3" id="mob-mat2-r3" accept="image/*" required>
                        </fieldset>
                    </div>
                    <div class="form-label">
                        <fieldset>
                            <legend>Mob matériel 2 rareté 4</legend>
                            <input type="file" name="mob-mat2-r4" id="mob-mat2-r4" accept="image/*" required>
                        </fieldset>
                    </div>
                </div>
                <div class="form-label-groups">
